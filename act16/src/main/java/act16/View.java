  ...
  public void messageHandler(String messageName, Object messagePayload) {
    switch(messageName) {
      ...
      case "model:selectedCardsChanged": {
        ...
        int count = setBorders(cardSelectedStatus, Constants.SELECTED_COLOR, Constants.LINE_WIDTH);
      ...
      case "model:gameStatus": {
        switch ((int)messagePayload) {
          ...
          case Constants.YOU_WIN:
            ...
            setAllBorders(Constants.WIN_COLOR, Constants.LINE_WIDTH);
            break;
            
          case Constants.YOU_LOSE:
            directionsLabel.setText("YOU LOSE!!  Game over!");
            setAllBorders(Constants.LOSE_COLOR, Constants.LINE_WIDTH);
            break;
