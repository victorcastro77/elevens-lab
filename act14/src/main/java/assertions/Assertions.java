...
public class Assertions {
  ...
  public static void assertEquals(String testSubject, Object a, Object b) {
    if (a == null || b == null) {
      sayFail(testSubject);
      return;
    }
  ...
  /**
   * Check if elements of two arrays equal each other
   * @param testSubject
   * @param a
   * @param b 
   */
  public static void assertArrayEquals(String testSubject, int[] a, int[] b) {
  ...
  public static void assertArrayEquals(String testSubject, boolean[] a, boolean[] b) {
    if (a == null || b == null || a.length == 0 || b.length == 0) {
      sayFail(testSubject);
      return;
    }
   ...
   * @param obj 
   */
  public static void assertNotNull(String testSubject, Object obj) {
    if (obj != null) sayPass(testSubject);
    else sayFail(testSubject);
  }
  
  public static void assertNull(String testSubject, Object obj) {
    if (obj == null) sayPass(testSubject);
    else sayFail(testSubject);
  }
